      ...
      <article className='-mt-[130px] ml-[60px] relative w-full h-auto flex justify-center'>
        <div>
            ...
            <div className='-mt-[670px] relative'>
                ...
                <h1 className='text-4xl text-black'>Inclusive and Fun</h1>
                ...
                <h1 className='text-4xl text-black'>Community-Centric </h1>
                ...
                <h1 className='text-4xl text-black'>Social Good: </h1>
