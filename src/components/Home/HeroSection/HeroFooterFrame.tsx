                ...
                <div className='relative'>
                    ...
                    <div className='flex justify-center'>
                        <div className='relative -top-[200px]'>
                            <div className='flex'>
                                <Button
                                    className='h-[36px] w-[36px] p-0 m-0 rounded-sm bg-sky_blue_primary flex justify-center items-center'
                                    onClick={() => {
                                        router.push('https://x.com/DegenTreats')
                                    }}
                                >
                                    <ImageIcon src='/assets/icons/twitter-icon.svg' alt='twitter-icon' imgClassName='mt-1.5'/>
                                </Button>
                            </div>
                        </div>
                    </div>
